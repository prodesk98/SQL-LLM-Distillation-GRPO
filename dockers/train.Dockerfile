...
RUN pip install "unsloth[colab-new] @ git+https://github.com/unslothai/unsloth.git" \
 && pip install "vllm @ git+https://github.com/unslothai/vllm.git" \
 && pip install trl peft xformers accelerate bitsandbytes duckdb loguru python-dotenv
